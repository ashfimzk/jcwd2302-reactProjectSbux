...
import { Link, redirect, Redirect,Navigate } from "react-router-dom";
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mt-8 flex flex-col items-center w-2/6 self-center my-bg-light drop-shadow-lg rounded-xl">
                ...
                <div className="mt-10 self-end mr-10 ">
                    <button className="my-bg-main px-7 py-3 rounded-full my-light text-xl mb-10 drop-shadow-lg font-bold" onClick={() => props.myFunc.onLogin(username.current.value, password.current.value)}>
                        Sign In
                    </button>
                    <button className="my-bg-main px-7 py-3 rounded-full my-light text-xl mb-10 drop-shadow-lg font-bold" onClick={props.loginGoogle.onLoginWithGoogle}>
                        Sign In with Google
                    </button>
                </div>
            </div>
